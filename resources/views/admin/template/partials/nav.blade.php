  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="#">Gestionar Empleados <span class="sr-only">(current)</span></a></li>
        <li><a href="#">Gestionar Contratos</a></li>
        <li><a href="#">Gestionar Reparticiones</a></li>
        <li class="dropdown">
