...
class Empleado extends Model
{
    ...
    protected $fillable = ['dni','nombre','apellido','programa_id','contrato_id','distribution_id','full']; //campos permitidos para mostrar los objetos json, es decir que datos quieros mostrar
